...
import { Platform } from '@otp-manager/shared/types';
...
const Dashboard: React.FC = () => {
  ...
  // Date formatting locale mapping
  const dateLocales = {
    'en': enUS,
    'zh-CN': zhCN,
    'zh-TW': zhTW,
  ...
  const [newPlatformManagement, setNewPlatformManagement] = useState({
    name: ''
  });
      ...
      setOtpCountdowns(prev => {
        ...
        newCountdowns.forEach((value, key) => {
          ...
          if (value > 0) {
            ...
            // Countdown ended, automatically refresh OTP only if platform exists
            if (platformExists) {
              handleGenerateOTP(key);
            }
            newCountdowns.delete(key);
            hasChanges = true;
          }
          ...
          <div className="flex justify-between items-center">
            ...
            <div className="flex items-center space-x-2 sm:space-x-3">
              ...
              <UserSettingsDropdown
                onShowChangePassword={() => setShowUserSettings(true)}
                  ...
                  <div className="mt-4 space-y-4">
                    ...
                    <div>
                      ...
                      <select
                        ...
                        className={`w-full px-3 py-2 border rounded-md dark:bg-gray-700 dark:text-white dark:border-gray-600 text-sm sm:text-base ${
                          formErrors.platformId ? 'border-red-500 dark:border-red-400' : 'border-gray-300 dark:border-gray-600'
                        }`}
                      >
                    ...
                    <div>
                      ...
                      <input
                        ...
                        className={`w-full px-3 py-2 border rounded-md dark:bg-gray-700 dark:text-white dark:border-gray-600 text-sm sm:text-base ${
                          formErrors.accountName ? 'border-red-500 dark:border-red-400' : 'border-gray-300 dark:border-gray-600'
                        }`}
                      />
                    ...
                    <div>
                      ...
                      <input
                        ...
                        className={`w-full px-3 py-2 border rounded-md dark:bg-gray-700 dark:text-white dark:border-gray-600 text-sm sm:text-base ${
                          formErrors.secret ? 'border-red-500 dark:border-red-400' : 'border-gray-300 dark:border-gray-600'
                        }`}
                      />
                      {formErrors.secret && (
                  ...
                  <div className="mt-4 space-y-4">
                    <div>
                      ...
                      <input
                        ...
                        className={`w-full px-3 py-2 border rounded-md dark:bg-gray-700 dark:text-white dark:border-gray-600 text-sm sm:text-base ${
                          platformManagementFormErrors.name ? 'border-red-500 dark:border-red-400' : 'border-gray-300 dark:border-gray-600'
                        }`}
