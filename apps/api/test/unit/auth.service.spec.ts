...
describe('AuthService', () => {
  ...
  describe('login', () => {
    ...
    it('should login successfully with valid credentials', async () => {
      ...
      expect(authRepository.findUserByEmail).toHaveBeenCalledWith(loginDto.email);
      expect(bcrypt.compare).toHaveBeenCalledWith(loginDto.password, mockUser.password);
      expect(authRepository.updateRefreshToken).toHaveBeenCalledWith(mockUser.id, 'refreshToken');
  ...
  describe('register', () => {
    ...
    it('should register successfully with new user', async () => {
      ...
      expect(authRepository.findUserByEmail).toHaveBeenCalledWith(registerDto.email);
      expect(authRepository.findUserByUsername).toHaveBeenCalledWith(registerDto.username);
  ...
  describe('refreshToken', () => {
    ...
    it('should refresh tokens successfully with valid refresh token', async () => {
      ...
      expect(authRepository.updateRefreshToken).toHaveBeenCalledWith(mockUser.id, 'newRefreshToken');
      expect(result).toEqual(mockTokens);
    });
  ...
  describe('logout', () => {
    ...
    it('should logout successfully with valid refresh token', async () => {
      ...
      expect(authRepository.updateRefreshToken).toHaveBeenCalledWith(payload.sub, null);
    });
