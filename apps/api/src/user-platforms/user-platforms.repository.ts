...
export class UserPlatformsRepository {
  ...
  async findByUserAndPlatform(userId: string, platformId: string): Promise<UserPlatformWithPlatform | null> {
  ...
  async findByUserPlatformAndAccount(userId: string, platformId: string, accountName: string): Promise<UserPlatformWithPlatform | null> {
    return this.prisma.userPlatform.findFirst({
      where: {
        userId,
        platformId,
